export const ru = {
    ...
    Auto_Suggest_Disabled: "Отключено",
    Auto_Suggest_Label: "Автоматические Предложения Ответов",
    Auto_Suggest_Placeholder: "Включить или отключить автоматические предложения",
    Qs_Select_Preview_Hint: "Пожалуйста, выберите ответ из списка предварительного просмотра. Введите `/qs` и поисковый запрос, чтобы увидеть подходящие ответы.",
}
